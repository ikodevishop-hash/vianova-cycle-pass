...
// product_type: 'rental'（レンタル）| 'lease'（リース＝新車2年契約・保険更新/メンテ込み）
const SEED_BIKES = [
  { id: 'BK01', name: 'Vianova City 7', emoji: '🚲', spec_short: '7段変速 / 27インチ / 軽量アルミ', spec_long: '通勤通学にぴったりのシティクロス。7段変速で坂道も快適。LEDライト・カゴ標準装備。', price_monthly: 3800, frame_no: 'VN-CITY-0001', insurance: '2027-03-31', color: 'ホワイト', security_no: '大阪 あ 10001', product_type: 'rental', note: '', photos: '[]', rented: 0 },
  { id: 'BK02', name: 'Vianova E-Power', emoji: '⚡', spec_short: '電動アシスト / 走行60km / 大容量バッテリー', spec_long: '坂道もすいすい進む電動アシスト。1回の充電で約60km。買い物にも通勤にも。', price_monthly: 7200, frame_no: 'VN-EP-0002', insurance: '2027-05-31', color: 'ブラック', security_no: '大阪 あ 10002', product_type: 'rental', note: '', photos: '[]', rented: 0 },
  { id: 'BK03', name: 'Vianova Mini Fold', emoji: '🛴', spec_short: '折りたたみ / 20インチ / 輪行可', spec_long: 'コンパクトに折りたためる人気モデル。電車との組み合わせや車載にも便利。', price_monthly: 4500, frame_no: 'VN-MF-0003', insurance: '2027-01-31', color: 'レッド', security_no: '大阪 あ 10003', product_type: 'rental', note: '', photos: '[]', rented: 0 },
  { id: 'BK04', name: 'Vianova Road S', emoji: '🚴', spec_short: 'ロードバイク / 16段変速 / カーボン', spec_long: '軽量カーボンフレームの本格ロード。週末のロングライドにおすすめ。', price_monthly: 9800, frame_no: 'VN-RD-0004', insurance: '2027-08-31', color: 'ネイビー', security_no: '大阪 あ 10004', product_type: 'rental', note: '', photos: '[]', rented: 0 },
  { id: 'BK05', name: 'Vianova City 7（新車リース）', emoji: '✨', spec_short: '新車 / 7段変速 / 27インチ', spec_long: '2年契約の新車リース。保険更新・定期メンテナンス込みで安心して長く乗れます。', price_monthly: 2980, frame_no: 'VN-LCITY-0001', insurance: '2028-03-31', color: 'ホワイト', security_no: '大阪 あ 20001', product_type: 'lease', note: '', photos: '[]', rented: 0 },
  { id: 'BK06', name: 'Vianova E-Power（新車リース）', emoji: '✨', spec_short: '新車 / 電動アシスト / 走行60km', spec_long: '2年契約の電動アシスト新車リース。保険更新・メンテナンス込み。通勤にも毎日の買い物にも。', price_monthly: 5800, frame_no: 'VN-LEP-0002', insurance: '2028-05-31', color: 'ブラック', security_no: '大阪 あ 20002', product_type: 'lease', note: '', photos: '[]', rented: 0 },
];
